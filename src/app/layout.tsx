...
export const metadata: Metadata = {
  ...
  title: '컴투스프로야구for매니저 아레나 도우미 [컴프매 아레나 도우미] | com2usManager Arena Helper',
  description:
    '컴투스프로야구for매니저 아레나 도우미 [컴프매 아레나 도우미] | 연도와 팀을 선택 후 오늘의 라인업을 정해 보세요! 오늘의 선수들을 한눈에 확인할 수 있습니다.',
  keywords:
  ...
  openGraph: {
    ...
    description:
      '컴투스프로야구for매니저 아레나 도우미 [컴프매 아레나 도우미] | 연도와 팀을 선택 후 오늘의 라인업을 정해 보세요! 오늘의 선수들을 한눈에 확인할 수 있습니다.',
    siteName: '컴투스프로야구for매니저 아레나 도우미 [컴프매 아레나 도우미] | com2usManager Arena Helper',
    images: [
      {
